    ...
    return (
        <div className="card p-6">
            <div className="flex items-center justify-between mb-6">
                <h3 className="text-lg font-bold text-slate-800">Developer Workload Imbalance</h3>
            </div>
            ...
            <div className="mt-4 bg-yellow-50 border border-yellow-100 rounded-lg p-4 flex gap-3">
